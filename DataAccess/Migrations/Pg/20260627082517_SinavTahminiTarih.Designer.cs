...
namespace DataAccess.Migrations.Pg
{
    ...
    [Migration("20260627082517_SinavTahminiTarih")]
    partial class SinavTahminiTarih
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Project.ArkadaslikIstegi", b =>
                {
                    ...
                    b.Property<bool>("GonderenKabulGordu")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.HasIndex("GonderenUserId", "Durum", "GonderenKabulGordu");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Project.KullaniciDersNetHedefi", b =>
                {
                    ...
                    b.HasIndex("UserId", "DersId")
                        .IsUnique();

                    b.ToTable("KullaniciDersNetHedefis");
                });
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Project.Sinav", b =>
                {
                    ...
                    b.Property<DateTime?>("TahminiTarih")
                        .HasColumnType("timestamp without time zone");
